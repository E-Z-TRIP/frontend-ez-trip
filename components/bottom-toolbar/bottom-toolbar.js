...
export default function BottomToolbar() {
  ...
  return (
    <View style={styles.toolBar}>
      <Entypo name='compass' size={35} color={route.name==='Discover' ? '#C46B4D':'black'} onPress={() => navigation.navigate('Discover')} />
      <Entypo name='heart-outlined' size={35} color={route.name==='MyTrips' ? '#C46B4D':'black'} onPress={() => navigation.navigate('MyTrips')} />
