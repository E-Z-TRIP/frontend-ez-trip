import { SafeAreaView, View, FlatList, Text, ImageBackground, TouchableOpacity, SliderBase, Animated, Modal, TouchableRipple, } from 'react-native';
      ...
      <View style={styles.recapTrip}>
        ...
        onRequestClose={() => {
          ...
          <View  style={styles.modal}>
            ...
            style= {styles.crossBoxModal} size={30} color='black' 
            ...
            <View style={styles.headerModal} >
              ...
              <FlatList  columnWrapperStyle={{ flexWrap: 'wrap', flex: 1 }} numColumns={3} data={[
                {key: 'Vol Paris/Bali'},
